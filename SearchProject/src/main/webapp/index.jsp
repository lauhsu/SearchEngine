...
function querydata(){
	var keyWord = $("#sid_").val();
	window.location.href = '/SearchProject/searchData?keyWord='+keyWord;
...
<div id="container">
	<div id="bd">
        <div id="main">
            ...
            <div class="inputArea">
            	<input type="text" id="sid_" value="dd" class="searchInput" />
                <input type="button" class="searchButton" onclick="querydata();" />
...
function querydata(){
	alert('1');
	window.location.href = '/SearchProject/searchData';
